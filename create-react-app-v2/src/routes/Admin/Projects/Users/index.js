...
// filter
import { userRole } from '../../../../utils/filter';
      ...
      <Card bordered={false}>
        ...
        <Table
          ...
          columns={[{
            ...
            title: '角色',
            key: 'role',
            render: (text, record) => <React.Fragment>{userRole(record.role)}</React.Fragment>,
          }, {
            title: '用户名',
            dataIndex: 'username',
            key: 'username',
            ...
            // dataIndex: 'ctime',
            key: 'ctime',
            render: (text, record) => <React.Fragment>{moment(record.ctime).format('YYYY-MM-DD HH:mm:ss')}</React.Fragment>,
          }, {
            title: '操作',
            key: 'action',
...
export default connect(state => ({
  page: state['project-users'].page,
  pageSize: state['project-users'].pageSize,
  loading: state['project-users'].loading,
  list: state['project-users'].list,
  total: state['project-users'].total,
}))(Users);
